...
/* eslint-diseble */ /* eslint-env es6 */ /* eslint-disable no-unused-vars */ var _polyfill = require("@babel/polyfill");
var _openLayerJs = require("./openLayer.js");
...
if (map) {
    ...
    (0, _openLayerJs.displayMap)(coordinate);
}
...
if (updateUserDataForm) updateUserDataForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _updateSettingsJs.updateData)(form, "data");
});
if (updatePasswordForm) updatePasswordForm.addEventListener("submit", async (e)=>{
    ...
    await (0, _updateSettingsJs.updateData)({
        passwordCurrent,
        password,
        passwordConfirm
    }, "password");
    document.querySelector("#btn--save-password ").textContent = "Alterar Senha";
...
},{"@babel/polyfill":"dTCHC","./openLayer.js":"jB05g","./login.js":"7yHem","./updateSettings.js":"l3cGY","./signup.js":"fNY2o","./stripe.js":"10tSC"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
const login = async (email, password)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "login realizado com sucesso");
            // window.setTimeout(() => {
            location.assign("/");
        // }, 1000);
        }
...
const updateData = async (data, type)=>{
    try {
        ...
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url: `/api/v1/users/${caminho}/`,
            data
        });
        // const res = await axios(config);
        if (res.data.status === "success") {
            const message = type === "password" ? "Senha atualizada com sucesso!" : "Dados atualizados com sucesso!";
...
const signup = async (name, email, password, passwordConfirm)=>{
    try {
        ...
        if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Cadastro realizado com sucesso");
...
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const stripe = Stripe("pk_test_51POgkdHEYoocmqIr5BqLFQuQM5lmUm9cPdmbiklB8VkoFTeKVx13MCCXgdGTbb7AfdbDgEKH01KCyTjq9rtxSx4d00v7eMJGhQ");
